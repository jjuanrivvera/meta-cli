...
Send a raw authenticated Graph request

```
metactl api METHOD PATH [flags]
```

### Examples

```
  metactl api GET me -q fields=id,name
  metactl api POST 123/feed -d '{"message":"Hello"}' --dry-run
```
