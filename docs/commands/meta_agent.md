...
* [meta agent classify](meta_agent_classify.md)	 - List command safety classifications
* [meta agent guard](meta_agent_guard.md)	 - Render host policy that blocks irreversible operations
