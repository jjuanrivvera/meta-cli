## metactl instagram media get

Get published media

```
metactl instagram media get MEDIA_ID [flags]
```
...
* [metactl instagram media](metactl_instagram_media.md)	 - Inspect published Instagram media
