## meta pages videos publish

Upload and publish a Page video in one workflow

```
meta pages videos publish [flags]
```

### Examples

```
  meta pages videos publish --file ./video.mp4 --title 'Launch' --thumbnail-file ./thumb.jpg
```
