## metactl whatsapp media get

Get WhatsApp media metadata and download URL

```
metactl whatsapp media get MEDIA_ID [flags]
```
...
* [metactl whatsapp media](metactl_whatsapp_media.md)	 - Manage WhatsApp media
