## metactl instagram comments hide

Hide or unhide a comment

```
metactl instagram comments hide COMMENT_ID [flags]
```
...
* [metactl instagram comments](metactl_instagram_comments.md)	 - Moderate Instagram comments
