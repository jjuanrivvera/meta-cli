## metactl pages reels upload

Upload local or hosted Page reel video

```
metactl pages reels upload VIDEO_ID [flags]
```
...
* [metactl pages reels](metactl_pages_reels.md)	 - Manage Page reels
