## metactl whatsapp templates create

Create a message template

```
metactl whatsapp templates create [flags]
```

### Examples

```
  metactl whatsapp templates create --name order_ready --language en_US --category UTILITY --components '[{"type":"BODY","text":"Order {{1}} is ready"}]'
```
...
* [metactl whatsapp templates](metactl_whatsapp_templates.md)	 - Manage WhatsApp message templates
