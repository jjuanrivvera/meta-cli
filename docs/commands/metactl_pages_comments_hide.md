## metactl pages comments hide

Hide or unhide a Page comment

```
metactl pages comments hide COMMENT_ID [flags]
```
...
```
  -h, --help     help for hide
      --hidden   hide when true; unhide when false (default true)
```
...
* [metactl pages comments](metactl_pages_comments.md)	 - Moderate Page comments
