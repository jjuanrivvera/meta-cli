## metactl pages accounts list

List Pages available to the active user token

```
metactl pages accounts list [flags]
```

### Examples

```
  metactl pages accounts list --all -o json
```
...
* [metactl pages accounts](metactl_pages_accounts.md)	 - List Pages and derived Page tokens
