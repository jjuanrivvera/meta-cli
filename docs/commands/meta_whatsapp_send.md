...
* [meta whatsapp send template](meta_whatsapp_send_template.md)	 - Send a WhatsApp template message (remote side effect)
* [meta whatsapp send text](meta_whatsapp_send_text.md)	 - Send a WhatsApp text message (remote side effect)
