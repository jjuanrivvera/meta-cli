...
* [metactl mcp cursor disable](metactl_mcp_cursor_disable.md)	 - Remove server from Cursor config
* [metactl mcp cursor enable](metactl_mcp_cursor_enable.md)	 - Add server to Cursor config
* [metactl mcp cursor list](metactl_mcp_cursor_list.md)	 - Show Cursor MCP servers
