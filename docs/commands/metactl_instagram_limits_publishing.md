## metactl instagram limits publishing

Get content publishing usage

```
metactl instagram limits publishing [flags]
```
...
* [metactl instagram limits](metactl_instagram_limits.md)	 - Inspect Instagram publishing limits
