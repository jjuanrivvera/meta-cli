## metactl instagram publish

Run composite Instagram publishing workflows
...
* [metactl instagram publish reel](metactl_instagram_publish_reel.md)	 - Publish a reel with a cover and optional first comment
