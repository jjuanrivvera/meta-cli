## metactl whatsapp profile update

Update the WhatsApp business profile

```
metactl whatsapp profile update [flags]
```
...
* [metactl whatsapp profile](metactl_whatsapp_profile.md)	 - Manage the WhatsApp business profile
