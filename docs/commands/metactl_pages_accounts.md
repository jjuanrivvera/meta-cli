## metactl pages accounts

List Pages and derived Page tokens
...
* [metactl pages accounts list](metactl_pages_accounts_list.md)	 - List Pages available to the active user token
