## meta whatsapp send template

Send a WhatsApp template message (remote side effect)

```
meta whatsapp send template [flags]
```

### Examples

```
  meta whatsapp send template --to 15551234567 --name order_ready --language en_US
```

### Options

```
      --components string   JSON components array
  -h, --help                help for template
      --language string     template language code (default "en_US")
