## metactl instagram insights media

Get Instagram media insights

```
metactl instagram insights media MEDIA_ID [flags]
```
...
* [metactl instagram insights](metactl_instagram_insights.md)	 - Read Instagram account and media insights
