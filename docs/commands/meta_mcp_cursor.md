...
* [meta mcp cursor disable](meta_mcp_cursor_disable.md)	 - Remove server from Cursor config
* [meta mcp cursor enable](meta_mcp_cursor_enable.md)	 - Add server to Cursor config
* [meta mcp cursor list](meta_mcp_cursor_list.md)	 - Show Cursor MCP servers
