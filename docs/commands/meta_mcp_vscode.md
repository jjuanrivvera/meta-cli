...
* [meta mcp vscode disable](meta_mcp_vscode_disable.md)	 - Remove server from VSCode config
* [meta mcp vscode enable](meta_mcp_vscode_enable.md)	 - Add server to VSCode config
* [meta mcp vscode list](meta_mcp_vscode_list.md)	 - Show VSCode MCP servers
