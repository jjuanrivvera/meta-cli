## metactl pages photos create

Publish a photo from a public URL

```
metactl pages photos create [flags]
```

### Examples

```
  metactl pages photos create --url https://cdn.example/photo.jpg --caption 'Launch'
```
...
* [metactl pages photos](metactl_pages_photos.md)	 - Manage Page photos
