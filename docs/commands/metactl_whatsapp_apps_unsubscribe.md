## metactl whatsapp apps unsubscribe

Unsubscribe the current app

```
metactl whatsapp apps unsubscribe [flags]
```
...
* [metactl whatsapp apps](metactl_whatsapp_apps.md)	 - Manage WhatsApp app subscriptions
