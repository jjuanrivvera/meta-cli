## metactl whatsapp phones get

Get phone status, quality, display-name, and registration fields

```
metactl whatsapp phones get [PHONE_ID] [flags]
```
...
* [metactl whatsapp phones](metactl_whatsapp_phones.md)	 - Inspect WhatsApp phone numbers
