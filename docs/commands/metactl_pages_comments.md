...
* [metactl pages comments delete](metactl_pages_comments_delete.md)	 - Delete a Page comment
* [metactl pages comments hide](metactl_pages_comments_hide.md)	 - Hide or unhide a Page comment
* [metactl pages comments list](metactl_pages_comments_list.md)	 - List comments on a Page object
* [metactl pages comments reply](metactl_pages_comments_reply.md)	 - Reply to a Page comment
