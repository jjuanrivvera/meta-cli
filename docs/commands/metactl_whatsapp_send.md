...
* [metactl whatsapp send template](metactl_whatsapp_send_template.md)	 - Send a WhatsApp template message (remote side effect)
* [metactl whatsapp send text](metactl_whatsapp_send_text.md)	 - Send a WhatsApp text message (remote side effect)
