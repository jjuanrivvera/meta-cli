## metactl whatsapp apps

Manage WhatsApp app subscriptions
...
* [metactl whatsapp apps list](metactl_whatsapp_apps_list.md)	 - List subscribed apps
* [metactl whatsapp apps subscribe](metactl_whatsapp_apps_subscribe.md)	 - Subscribe the current app
* [metactl whatsapp apps unsubscribe](metactl_whatsapp_apps_unsubscribe.md)	 - Unsubscribe the current app
