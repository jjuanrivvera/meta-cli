...
* [metactl mcp vscode disable](metactl_mcp_vscode_disable.md)	 - Remove server from VSCode config
* [metactl mcp vscode enable](metactl_mcp_vscode_enable.md)	 - Add server to VSCode config
* [metactl mcp vscode list](metactl_mcp_vscode_list.md)	 - Show VSCode MCP servers
