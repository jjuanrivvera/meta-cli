...
* [meta whatsapp templates create](meta_whatsapp_templates_create.md)	 - Create a message template
* [meta whatsapp templates delete](meta_whatsapp_templates_delete.md)	 - Delete one template translation by id, or all translations by name
* [meta whatsapp templates get](meta_whatsapp_templates_get.md)	 - Get a message template
* [meta whatsapp templates list](meta_whatsapp_templates_list.md)	 - List message templates
* [meta whatsapp templates update](meta_whatsapp_templates_update.md)	 - Update a message template
