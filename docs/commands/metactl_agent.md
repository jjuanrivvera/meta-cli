...
Generate automation safety policy from command annotations
...
* [metactl agent classify](metactl_agent_classify.md)	 - List command safety classifications
* [metactl agent guard](metactl_agent_guard.md)	 - Render host policy that blocks irreversible operations
