## metactl whatsapp accounts get

Get the configured WhatsApp Business Account

```
metactl whatsapp accounts get [flags]
```
...
* [metactl whatsapp accounts](metactl_whatsapp_accounts.md)	 - Manage WhatsApp Business Accounts
