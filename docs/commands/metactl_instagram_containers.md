## metactl instagram containers

Manage Instagram media containers
...
* [metactl instagram containers create](metactl_instagram_containers_create.md)	 - Create an image, video, reel, carousel, or story container
* [metactl instagram containers publish](metactl_instagram_containers_publish.md)	 - Publish a finished media container
* [metactl instagram containers status](metactl_instagram_containers_status.md)	 - Get media container processing status
* [metactl instagram containers upload](metactl_instagram_containers_upload.md)	 - Upload local or hosted video bytes to a resumable container
