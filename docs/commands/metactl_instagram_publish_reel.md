## metactl instagram publish reel

Publish a reel with a cover and optional first comment

```
metactl instagram publish reel [flags]
```

### Examples

```
  metactl instagram publish reel --video ./reel.mp4 --cover-url https://cdn.example/cover.jpg --caption 'Launch' --first-comment 'Details in bio'
```
...
* [metactl instagram publish](metactl_instagram_publish.md)	 - Run composite Instagram publishing workflows
