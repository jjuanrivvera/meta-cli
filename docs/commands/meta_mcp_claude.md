...
* [meta mcp claude disable](meta_mcp_claude_disable.md)	 - Remove server from Claude config
* [meta mcp claude enable](meta_mcp_claude_enable.md)	 - Add server to Claude config
* [meta mcp claude list](meta_mcp_claude_list.md)	 - Show Claude MCP servers
