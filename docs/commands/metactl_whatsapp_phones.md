## metactl whatsapp phones

Inspect WhatsApp phone numbers
...
* [metactl whatsapp phones get](metactl_whatsapp_phones_get.md)	 - Get phone status, quality, display-name, and registration fields
* [metactl whatsapp phones list](metactl_whatsapp_phones_list.md)	 - List phone numbers and operational status
