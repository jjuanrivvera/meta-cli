...
Inspect and edit non-secret account settings
...
* [metactl config list-accounts](metactl_config_list-accounts.md)	 - List configured accounts
* [metactl config path](metactl_config_path.md)	 - Print the config file path
* [metactl config remove](metactl_config_remove.md)	 - Remove non-secret account settings
* [metactl config set](metactl_config_set.md)	 - Create or update an account
* [metactl config use](metactl_config_use.md)	 - Select the default account
* [metactl config view](metactl_config_view.md)	 - Show configuration without credentials
