## metactl pages videos upload

Upload an idempotent video chunk

```
metactl pages videos upload SESSION_ID [flags]
```

### Options

```
      --file string           video chunk file
  -h, --help                  help for upload
      --start-offset string   chunk start offset (default "0")
```
...
* [metactl pages videos](metactl_pages_videos.md)	 - Manage resumable Page video uploads
