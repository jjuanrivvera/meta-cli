...
* [metactl auth debug](metactl_auth_debug.md)	 - Inspect the active token with debug_token
* [metactl auth exchange](metactl_auth_exchange.md)	 - Exchange the active user token for a long-lived token
* [metactl auth login](metactl_auth_login.md)	 - Verify and store an access token
* [metactl auth logout](metactl_auth_logout.md)	 - Delete the stored credential
* [metactl auth pages](metactl_auth_pages.md)	 - List Pages and derived Page access tokens
* [metactl auth status](metactl_auth_status.md)	 - Verify the active identity
