## metactl instagram accounts list

Get the Instagram account linked to the Page

```
metactl instagram accounts list [flags]
```

### Examples

```
  metactl instagram accounts list --page-id 123 -o json
```
...
* [metactl instagram accounts](metactl_instagram_accounts.md)	 - Discover the Instagram account linked to a Page
