...
* [metactl mcp claude disable](metactl_mcp_claude_disable.md)	 - Remove server from Claude config
* [metactl mcp claude enable](metactl_mcp_claude_enable.md)	 - Add server to Claude config
* [metactl mcp claude list](metactl_mcp_claude_list.md)	 - Show Claude MCP servers
