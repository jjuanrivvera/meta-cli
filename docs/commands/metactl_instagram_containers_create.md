## metactl instagram containers create

Create an image, video, reel, carousel, or story container

```
metactl instagram containers create [flags]
```

### Examples

```
  metactl instagram containers create --type reel --url https://cdn.example/reel.mp4 --cover-url https://cdn.example/cover.jpg --caption 'Launch day'
```
