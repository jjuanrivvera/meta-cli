## metactl instagram accounts

Discover the Instagram account linked to a Page
...
* [metactl instagram accounts list](metactl_instagram_accounts_list.md)	 - Get the Instagram account linked to the Page
