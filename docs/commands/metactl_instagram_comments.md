...
* [metactl instagram comments create](metactl_instagram_comments_create.md)	 - Create a comment on media
* [metactl instagram comments delete](metactl_instagram_comments_delete.md)	 - Delete a comment
* [metactl instagram comments hide](metactl_instagram_comments_hide.md)	 - Hide or unhide a comment
* [metactl instagram comments list](metactl_instagram_comments_list.md)	 - List media comments
* [metactl instagram comments replies](metactl_instagram_comments_replies.md)	 - List replies to a comment
* [metactl instagram comments reply](metactl_instagram_comments_reply.md)	 - Reply to a comment
